<p align="center">
  <img src="./clodds.png" alt="Clodds Logo" width="280">
</p>
...
<p align="center">
  <a href="https://github.com/alsk1992/CloddsBot"><img src="https://img.shields.io/badge/fork%20of-alsk1992%2FCloddsBot-blue" alt="Fork of alsk1992/CloddsBot"></a>
  <img src="https://img.shields.io/badge/maintainer-ilyaosovskoi-orange" alt="Maintainer">
</p>
...
```bash
git clone https://github.com/ilyaosovskoi/CloddsBot.git && cd CloddsBot
npm install && cp .env.example .env
# Add your ANTHROPIC_API_KEY (or GEMINI_API_KEY) to .env
...
│ Settlement       │ │ Real-time    │ │ Real-time    │ │ Liquidation │ │ Fully        │
│ Tracking         │ │ Price Feeds  │ │ Price Feeds  │ │ Monitoring  │ │ On-chain     │
└──────────────────┘ │              │ │              │ │             │ │              │
                     │ Chainlink    │ │ Chainlink    │ │ Funding     │ │ No KYC       │
    │ Gamma API │    │ Feeds        │ │ Feeds        │ │ Rates       │ └──────────────┘
    │ Poll for  │    │              │ │              │ │             │
    │ rounds    │    │ Execution    │ │ Execution    │ │ Execution   │
    │ Execution │    └──────────────┘ └──────────────┘ └─────────────┘
    └──────────┘
                     │                │                │
    ┌────────────────┴────────────────┴────────────────┴──────────────┐
...
```bash
# Required
ANTHROPIC_API_KEY=sk-ant-...  # or GEMINI_API_KEY, etc.
...
This is a fork of [alsk1992/CloddsBot](https://github.com/alsk1992/CloddsBot). The original project was created by **ALSK**. This fork is maintained by **ilyaosovskoi**.
